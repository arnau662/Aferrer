    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_REQUEST["enviar"]) && comprovar_email_db($_REQUEST["mail"])) {
            ...
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'aferrerg@fp.insjoaquimmir.cat';
                $mail->Password   = 'aferrerg2020';
                $mail->SMTPSecure = 'tls';
                $mail->Port       = 587;
                ...
                $mail->Body    = 'Tu pin: '.$pin.'<br>Entra en este enlace para recuperar tu contraseña: <a href="https://dawjavi.insjoaquimmir.cat/aferrer/Uf1/prova_uf1/B/cambiar.php">Entrar</a>';
                $mail->AltBody = 'Codigo: ';
